"""Change start_urls to desired blogspot blog url
Also change condition for outgoing links to this url"""
...
class test_spider(scrapy.Spider):
    ...
    start_urls = ['http://ablogonthespectrum.blogspot.com/']
    ...
    # using xpath to get the title  
      ...
      try:
        ...
        for href in response.xpath('//div[@class="post-body entry-content"]/descendant-or-self::a/@href'):
          ...
          if 'http://ablogonthespectrum.blogspot.com/' not in extracted:
