        ...
        for y in range(len(predicted[x])):
            ...
            if not index2 in framelist:
                if predicted[x][y] == 1 and y_array_test[x][y] == 1:
                    is_found_p = True
                    print str(index_dictionary.get(index2))
...
def voting_classifier_new(vote_array, sentences, threshold, verbose):
        ...
        for y in range(15):
            ...
            if vote_array[x][y] >= threshold:
                ...
                if verbose:
                    ...
                    output += str(index_dictionary.get(y)) + " " + str(vote_array[x][y])
                    output += "\n"
            count += 1
    ...
    return [sentences, index_dictionary, vote_array, output]
        ...
        for y in range(15):
            ...
            if vote_array[x][y] >= threshold and y_array_test[x][y] == 1:
                ...
                if verbose:
                    ...
                    print str(index_dictionary.get(y)) + " " + str(vote_array[x][y])
            ...
            # False positive
                ...
                if verbose:
                    ...
                    print Colors.BLUE + str(index_dictionary.get(y)) + " " + str(vote_array[x][y])
            count += 1
...
print "Dummy Classifier:" + Colors.RESET
...
if load_classifiers[1]:
    try:
        print "One Vs Rest Linear SVC Classifier"
...
if load_classifiers[4]:
    try:
        print "MLP sgd Neural Net Classifier"
...
if load_classifiers[4]:
    try:
        print "MLP adam Neural Net Classifier"
...
if load_classifiers[4]:
    try:
        print "MLP lbfgs Neural Net Classifier"
