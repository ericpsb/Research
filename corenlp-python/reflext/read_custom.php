...
<body>
    <div id="passage">
        <?php for ($i = 0; $i < count($words); $i++) { 
            ...
            if ($str[0] == "<") {
                ...
                print "<span id=s-" . $i . " class=\"space\">&nbsp;</span>
                <span id = " . $i . " class=\"passage_words\" 
                style= 'background: rgba(255, ". (int) (255 * (1.0 - $normalizedArray[$i])) 
                    .", 0,". (($normalizedArray[$i] > 0) ? "0.5" : "0") .")'>" . $str . "</span>";
            } 
        } 
        ?>
    </div>
    <div id="annotated">
        <form id = "ator_checkboxes" action="#">
            ...
            <input type ="checkbox" name = "checkcustom" id="checkcustom"/> Custom annotation
            <input type="text" name="customAnn" id="customAnn"/>
        </form>
        <p id = "errorMsg"> </p>
    </div>
</body>
