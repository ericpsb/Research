...
def wc(stringofwords):
  stringofwords = nltk.clean_html(stringofwords) #clean html from original document
  stringofwords = stringofwords.encode() #convert from unicode to ascii
  stringofwords = re.sub(r'(\')', "", stringofwords) #take out apostrophes
